...
def sentence_to_avg(sentence, word_to_vec_map):
    ...
    avg = 0 #np.zeros(next(iter(word_to_vec_map.values())).shape)
...
def Emojify_V2(input_shape, word_to_vec_map, word_to_index):
    ...
    sentence_indices = Input(shape=input_shape, dtype='int32') #sentences_to_indices(X, word_to_index, max_len)
